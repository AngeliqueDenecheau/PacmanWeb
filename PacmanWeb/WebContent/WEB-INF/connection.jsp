		  ...
		  <div class="card-header">
		    <ul class="nav nav-pills justify-content-center card-header-pills">
		      <li class="nav-item" role="presentation">
			    <button class="nav-link <c:if test="${requestScope.type == 'subscribe'}">active</c:if>" id="pills-subscribe-tab" data-bs-toggle="pill" data-bs-target="#pills-subscribe" type="button" role="tab" aria-controls="pills-subscribe" aria-selected="true">Inscription</button>
			  </li>
		      <li class="nav-item" role="presentation">
			    <button class="nav-link <c:if test="${requestScope.type == 'login'}">active</c:if>" id="pills-login-tab" data-bs-toggle="pill" data-bs-target="#pills-login" type="button" role="tab" aria-controls="pills-login" aria-selected="false">Connection</button>
			  </li>
		    </ul>
		  </div>
		  <div class="card-body">
		    <div class="tab-content" id="pills-tabContent">
			  <div class="tab-pane fade <c:if test="${requestScope.type == 'subscribe'}">show active</c:if>" id="pills-subscribe" role="tabpanel" aria-labelledby="pills-subscribe-tab">
			  ...
			  <div class="tab-pane fade <c:if test="${requestScope.type == 'login'}">show active</c:if>" id="pills-login" role="tabpanel" aria-labelledby="pills-login-tab">
